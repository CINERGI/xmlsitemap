		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1>XML Sitemap</h1>
					<p class="expl">
						This is an XML Sitemap, meant for consumption by search engines. The html presentation is based on an xslt from <a href="http://yoast.com/">Yoast de Valk</a>. Generated by python script accessing the CINERGI Elastic Search instance. See code in <a href="https://github.com/CINERGI/xmlsitemap">CINERGI Github</a>.<br/>
